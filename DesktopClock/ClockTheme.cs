    ...
    public static IReadOnlyList<ClockTheme> GetBuiltInThemes()
    {
        return new[]
        {
            ...
            new ClockTheme("Terminal", "Consolas", "Bold",
                Color.FromRgb(0x00, 0xE5, 0xFF), Color.FromRgb(0x11, 0x11, 0x11),
                backgroundEnabled: true, backgroundOpacity: 0.85, backgroundCornerRadius: 4, outlineThickness: 0.2),
            ...
            new ClockTheme("Card", "Segoe UI", "SemiBold",
                Color.FromRgb(0xEC, 0xEC, 0xF1), Color.FromRgb(0x2B, 0x2B, 0x2B),
                backgroundEnabled: true, backgroundOpacity: 0.95, backgroundCornerRadius: 12, outlineThickness: 0.2),
            new ClockTheme("Paper", "Georgia", "Normal",
                Color.FromRgb(0x1A, 0x1A, 0x1A), Color.FromRgb(0xFA, 0xFA, 0xF8),
                backgroundEnabled: true, backgroundOpacity: 0.95, backgroundCornerRadius: 6, outlineThickness: 0.2),
            new ClockTheme("Neon", "Segoe UI", "Bold",
                Color.FromRgb(0xFF, 0x2E, 0x98), Color.FromRgb(0x14, 0x14, 0x1E),
                backgroundEnabled: false, backgroundOpacity: 1, backgroundCornerRadius: 1, outlineThickness: 1,
                fontStyle: "Italic"),
            new ClockTheme("Sunset", "Segoe UI", "Bold",
                Color.FromRgb(0xFF, 0x8C, 0x42), Color.FromRgb(0x18, 0x14, 0x26),
                backgroundEnabled: true, backgroundOpacity: 0.9, backgroundCornerRadius: 8, outlineThickness: 0.2),
        };
    }
